...
FlotacionPracticaSystem::FlotacionPracticaSystem(Gravity* g, FloatForce* f)
{
    ...
    objeto = new Particle(700.0, Vector3(650, 20, 0), Vector3(0, 0, 0), Vector3(0, 0, 0), 0.3f, 500.0f, Vector4(0.0f, 1.0f, 0.0f, 1.0f), 1.0f);
 
    objeto->setShape(2);//que sea cubo
    objeto->setGeometry();


    agua = new Particle(700.0, Vector3(650,0, 0), Vector3(0.0f, 0, 0), Vector3(0, 0, 0), 0.4f, 1.0f, Vector4(0.0f, 0.0f, 1.5f, 1.0f), 1.0f);
    agua->setH(1.0f);
    agua->setP(10.0f);
    agua->setW(10.0f); 
